...
export default function Create({ lgus, agencies }) {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4">
      ...
      <p className="text-sm text-textmuted">AI pre-screening checks completeness and compliance automatically.</p>

      <form onSubmit={submit} className="space-y-4 rounded-2xl border border-brandborder bg-card p-4 shadow-sm">
        <div>
          <label htmlFor="ptype" className="mb-1 block text-sm font-medium text-textmuted">Permit type</label>
        ...
        <div>
          <label htmlFor="plgu" className="mb-1 block text-sm font-medium text-textmuted">City / Municipality (for local permits)</label>
        ...
        <div>
          <label htmlFor="pagency" className="mb-1 block text-sm font-medium text-textmuted">National agency (for national permits)</label>
        ...
        <div>
          <label htmlFor="pdesc" className="mb-1 block text-sm font-medium text-textmuted">Project description</label>
        ...
        <div>
          <label htmlFor="docs" className="mb-1 block text-sm font-medium text-textmuted">Documents (PDF/images, max 10MB each)</label>
